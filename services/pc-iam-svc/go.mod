module github.com/medhen/pc-iam-svc
...
require (
	...
	github.com/medhen/pc-auth-sdk v0.0.0
	github.com/medhen/pc-idempotency-mgmt-sdk v0.0.0
	github.com/medhen/pc-telemetry-sdk v0.0.0
